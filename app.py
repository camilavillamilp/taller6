...
st.markdown(
    ...
    /* Botón de "Clasificar envío": lo sacamos del negro por defecto
       y lo ponemos en un coral que combina con la paleta de la app */
    div[data-testid="stFormSubmitButton"] button {
        background-color: #E8899A !important;
    ...
    div[data-testid="stFormSubmitButton"] button:hover {
        background-color: #D96E82 !important;
        color: #FFFFFF !important;
    }
